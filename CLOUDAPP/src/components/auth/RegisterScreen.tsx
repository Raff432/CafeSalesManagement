...
export function RegisterScreen({ onLogin, onRegister }: RegisterScreenProps) {
...
const styles = StyleSheet.create({
  ...
  headerWrap: { flexDirection: 'row', alignItems: 'center', marginBottom: 20 },
  backBtn: {
    position: 'absolute',
    left: 0,
    padding: 8,
  ...
  header: { flex: 1, textAlign: 'center', fontSize: 18, fontWeight: '600' },
